...
<div class="container-fluid w-100 h-100 p-0 m-0">
    <div class="row w-100 h-100 p-0 m-0">
        ...
        <div class="col-md-4 p-0 m-0 login">
            <div class="w-100 bg-white p-0 m-0 h-75">
                <div class="row text-center login" style="height: 10%">
                    <div class="row col-md-12 title login">Chỉnh sửa khách hàng</div>
                </div>
                <form action="/product?action=edit&id=${productIndex}" method="post" style="height: 80%">
                    <div class="p-3" >
                        <div class="form-group ">
                            <label class="text-dark font-weight-bold">No.1</label>
                            <input type="text"
                        ...
                        <button type="submit" class="btn btn-dark w-100 font-weight-bold">Chỉnh sửa</button>
                    </div>
                </form>
            </div>
        </div>
